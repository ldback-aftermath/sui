...
* Object Inputs: A list of unique object references pointing to objects that will be passed to this function. Each object must either be owned by the senderm, immutable or shared. *The gas input object from above cannot also appear as an object input.*
